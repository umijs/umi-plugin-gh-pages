...
var ghpages__default = /*#__PURE__*/_interopDefaultLegacy(ghpages);
...
var index = (function (api) {
  ...
  function publish(args) {
    ...
    return new Promise(function (resolve, reject) {
      ghpages__default['default'].publish(dir || paths.absOutputPath, _objectSpread2(_objectSpread2({}, ghpagesArgs), args), function (err) {
        if (err) {
          return reject(err);
        } // @ts-ignore
